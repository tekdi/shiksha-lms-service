...
export class CloneLessonDto {
  ...
  @IsNotEmpty({ message: VALIDATION_MESSAGES.COMMON.REQUIRED('New module ID') })
  @IsUUID('4', { message: VALIDATION_MESSAGES.COMMON.UUID('New module ID') })
  newModuleId: string;
}
