export const API_IDS = {
  ...
  RECALCULATE_PROGRESS_JOB_STATUS: 'api.tracking.recalculate.progress.job.status',
  LIST_RECALCULATE_PROGRESS_JOBS: 'api.tracking.recalculate.progress.jobs.list',
